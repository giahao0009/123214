            ...
            <div class="grid">
                <div class="grid__row">
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product" style="margin-top: 20px;">
                            <!-- Grid -> row ->column -->
                            <hr style="border-color: brown;">
                            <h3 style="font-size: 1.8rem; color: var(--primary-color);">SẢN PHẨM MỚI</h3>
                            <hr>
                            <div class="gird">
                                <div class="grid__row">
                                    <div class="grid__column-2-4">
                                        <a href="" class="home-product-link">
                                            <div class="home-product-item">
                                                ...
                                                <hr>
                                                <h4 class="home-product-item__name">Converse 4</h4>
                                                <div class="home-product-item__price">
                                                    <div class="home-product-item__price-deal">1.200.000 đ</div>
                                                    <div class="home-product-item__price-current"><strike
                                                            style="color: var(--text-color);">1.400.000 đ</strike></div>
                                                </div>
                                        ...
                                        <a href="" class="home-product-link">
                                            <div class="home-product-item">
                                                <img src="./assets/img/san-pham-ao-khoac-02.webp" width="100%"
                                                    class="home-product-item__img">
                                                <hr>
                                                <h4 class="home-product-item__name">Bing Bling Jacket</h4>
                                                <div class="home-product-item__price">
                                                    <div class="home-product-item__price-deal">460.000 đ</div>
                                                    <div class="home-product-item__price-current"><strike
                                                            style="color: var(--text-color);">580.000 đ</strike></div>
                                                </div>
                                                <div class="home-product-item__action">
                                                    <span
                                                        class="home-product-item__like home-product-item__like--liked">
                                        ...
                                        <a href="" class="home-product-link">
                                            <div class="home-product-item">
                                                <img src="./assets/img/san-pham-8.webp" width="100%"
                                                    class="home-product-item__img">
                                                <hr>
                                                <h4 class="home-product-item__name">Melting Gum Tee</h4>
                                                <div class="home-product-item__price">
                                                    <div class="home-product-item__price-deal">280.000 đ</div>
                                                    <div class="home-product-item__price-current"><strike
                                                            style="color: var(--text-color);">350.000 đ</strike></div>
                                                </div>
                                                <div class="home-product-item__action">
                                                    <span
                                                        class="home-product-item__like home-product-item__like--liked">
                                        ...
                                        <a href="" class="home-product-link">
                                            <div class="home-product-item">
                                                <img src="./assets/img/san-pham-10.webp" width="100%"
                                                    class="home-product-item__img">
                                                <hr>
                                                <h4 class="home-product-item__name">SS2 Shoulder Bag</h4>
                                                <div class="home-product-item__price">
                                                    <div class="home-product-item__price-deal">300.000 đ</div>
                                                    <div class="home-product-item__price-current"><strike
                                                            style="color: var(--text-color);">380.000 đ</strike></div>
                                                </div>
                                                <div class="home-product-item__action">
                                                    <span
                                                        class="home-product-item__like home-product-item__like--liked">
                                ...
                                <div class="gird__row">
                                    <div class="gird__column-12" style="width: 100%; overflow: hidden;">
                                        <img src="https://bizweb.dktcdn.net/100/091/132/themes/801201/assets/large_banner_1.jpg?1607739015481"
                                            style="margin-top: 30px;" class="adv-img-deal" width="100%">
                                    </div>
                                </div>
                                <hr style="border-color: brown;">
                                <h3 style="font-size: 1.8rem; color: var(--primary-color);">SẢN PHẨM KHUYẾN MÃI</h3>
                                <hr>
                                <div class="gird">
                                    <div class="grid__row">
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-9.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Tiedye Shorts Grey</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">230.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">380.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                                            class="home-product-item__like home-product-item__like--liked">
                                                            <i
                                                                class="home-product-item__like-icon-empty far fa-heart"></i>
                                                            <i
                                                                class="home-product-item__like-icon-fill fas fa-heart"></i>
                                                        </span>
                                                        <div class="home-product-item__rating">
                                                            <i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-11.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Tiedye Hat Grey</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">250.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-12.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Stuffed Wolf</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">210.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">300.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-13.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Hades Thunder Backpack</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">400.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">550.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-14.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Hades Bag Pack</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">400.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">550.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-15.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Flamboyant Sweater</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">320.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">460.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-16.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Skeleton Hoodie</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">480.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">600.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/giay-3.jpg" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Converse All Star ii</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">1.200.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">1.400.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                    ...
                                    <div class="gird__row">
                                        <div class="gird__column-12" style="width: 100%; overflow: hidden;">
                                            <img src="./assets/img/Thiết kế không tên.gif" style="margin-top: 30px;"
                                                class="adv-img-deal" width="100%" height="350px">
                                        </div>
                                    </div>
                                </div>
                                <hr style="border-color: brown;">
                                <h3 style="font-size: 1.8rem; color: var(--primary-color);">SẢN PHẨM NỔI BẬT</h3>
                                <hr>
                                <div class="gird">
                                    <div class="grid__row">
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/giay-4.jpg" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Star Floral Crochet</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">600.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">750.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/giay-5.jpg" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Converse All Star</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">500.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">800.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-17.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Lighting Strike Shorts</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">190.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">380.000 đ</strike>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-18.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Dead Inside Pants</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">250.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">420.000 đ</strike>
                                                        </div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-19.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Zipped Purse</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">300.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">620.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-21.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Apocalypse Tee</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">210.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                        ...
                                        <div class="grid__column-2-4">
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    <img src="./assets/img/san-pham-22.webp" width="100%"
                                                        class="home-product-item__img">
                                                    <hr>
                                                    <h4 class="home-product-item__name">Hatred Black Tee</h4>
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">320.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">350.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
                                            ...
                                            <a href="" class="home-product-link">
                                                <div class="home-product-item">
                                                    ...
                                                    <div class="home-product-item__price">
                                                        <div class="home-product-item__price-deal">400.000 đ</div>
                                                        <div class="home-product-item__price-current"><strike
                                                                style="color: var(--text-color);">450.000
                                                                đ</strike></div>
                                                    </div>
                                                    <div class="home-product-item__action">
                                                        <span
