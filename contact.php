...
<body class="modal-open" id="body">
    ...
    <div class="app">
        ...
        <!-- Contact -->
        <div class="img-homepage" style="margin-top: 45px;">
            <div class="app-container__contact">
            <div class="contact grid">
                <h4 class="form-contact__title">Liên hệ với chúng tôi</h4>
                <p class="form-contact__description">Quý khách vui lòng điền đầy đủ thông tin sau: </p>
                <form class="form-contact" name="contactForm" onsubmit="return validateFormContact();">
                    <hr>
                    <div class="form-group">
                        <label for="">Họ và tên <span style="color: red;">*</span></label><br>
                        <input class="form-contact__input" type="text" name="fullName">
                    </div>
                    <div class="form-group">
                        <label for="">Email của bạn <span style="color: red;">*</span></label><br>
                        <input class="form-contact__input" type="email" name="email">
                    </div>
                    <div class="form-group">
                        <label for="">Số điện thoại của bạn <span style="color: red;">*</span></label><br>
                        <input class="form-contact__input" type="text" name="phone">
                    </div>
                    <div class="form-group">
                        <label for="">Bạn cần</label><br>
                        <select class="form-contact__input" name="selection" id="">
                            <option>Đóng góp ý kiến</option>
                            <option>Khiếu nại sản phẩm</option>
                            <option>Ý kiến dịch vụ</option>
                            <option>Tư vấn sản phẩm</option>
                            <option>Khác ...</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="">Tiêu đề <span style="color: red;">*</span></label><br>
                        <input class="form-contact__input" type="text" name="title"><br>
                    </div>
                    <div class="form-group">
                        <label for="">Nội dung cần liên hệ <span style="color: red;">*</span></label><br>
                        <textarea class="form-contact__textarea" cols="30" rows="10" name="content"></textarea>
                    </div>
                    <button type="submit" class="form-contact__btn">Gửi đi</button>
                </form>
            </div>
        </div>
        </div>
        ...
        <footer class="footer">
            <div class="grid">
                ...
                <div class="footer__info">
                    ...
                    <p>Địa chỉ: Tầng 28, Tòa nhà Landmark 81, 208 Nguyễn Hữu Cảnh, Phường 12, Quận Bình Thạnh, Thành Phố
